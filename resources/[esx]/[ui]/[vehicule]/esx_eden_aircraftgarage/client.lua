...
function StockVehicleMenu()
	...
	if IsPedInAnyVehicle(playerPed,  false) then
		...
		ESX.TriggerServerCallback('eden_aircraftgarage:stockv',function(valid)
			...
			if (valid) then
				TriggerServerEvent('eden_aircraftgarage:debug', "plaque vehicule rentree au garage: "  .. vehicleProps.plate)
				TriggerServerEvent('eden_aircraftgarage:logging',"santee vehicule rentree au garage: " .. engineHealth)
