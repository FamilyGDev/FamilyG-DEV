...
--			ESX.TriggerServerCallback('eden_boatgarage:getOwnedProperties', function(properties)
...
function StockVehicleMenu()
	...
	if IsPedInAnyVehicle(playerPed,  false) then
		...
		ESX.TriggerServerCallback('eden_boatgarage:stockv',function(valid)
			...
			if (valid) then
				TriggerServerEvent('eden_boatgarage:debug', "plaque vehicule rentree au garage: "  .. vehicleProps.plate)
				TriggerServerEvent('eden_boatgarage:logging',"santee vehicule rentree au garage: " .. engineHealth)
...
function SpawnPoundedVehicle(vehicle)
	...
	TriggerServerEvent('eden_boatgarage:modifystate', vehicle, true)
